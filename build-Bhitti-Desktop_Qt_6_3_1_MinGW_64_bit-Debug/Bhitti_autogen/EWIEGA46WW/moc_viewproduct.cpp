...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ViewProduct_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ViewProduct_t qt_meta_stringdata_ViewProduct = {
    {
QT_MOC_LITERAL(0, 11) // "ViewProduct"
...
const QMetaObject ViewProduct::staticMetaObject = { {
    ...
    qt_meta_stringdata_ViewProduct.offsetsAndSize,
    qt_meta_data_ViewProduct,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ViewProduct_t
, QtPrivate::TypeAndForceComplete<ViewProduct, std::true_type>
