...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_NewOrder_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_NewOrder_t qt_meta_stringdata_NewOrder = {
    {
QT_MOC_LITERAL(0, 8) // "NewOrder"
...
const QMetaObject NewOrder::staticMetaObject = { {
    ...
    qt_meta_stringdata_NewOrder.offsetsAndSize,
    qt_meta_data_NewOrder,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_NewOrder_t
, QtPrivate::TypeAndForceComplete<NewOrder, std::true_type>
